...
$arrProducts = array(
    ...
    // array(
    //     'products_name' => 'autapprove30', // Obligatoriu pentru forma detailata / Mandatory for detailed form
    //     'products_model' => 'autapprove30', // Obligatoriu pentru forma detailata / Mandatory for detailed form
    ...
    //     'products_image' => 'http://s.cel.ro/includes/templates/cel/images/logo.png', // Obligatoriu pentru forma detailata / Mandatory for detailed form
    ...
    // Second product -> short form (already approved products)
     array(
        ...
        'pretf' => 150, // Trebuie cel putin 1 camp dintre 'pretf' si 'stoc' / At least one field between 'pretf' and 'stoc' is necessary
    ...
    // array(
    //     'products_model' => 'TTK31E', // Obligatoriu pentru forma scurta / Mandatory for short form
