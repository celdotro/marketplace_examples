...
$arrProducts = array(
    ...
    // 'hasTVA' => 0 // Camp optional care poate intra in conflict cu cel specificat la linia de produs. Verificati pagina de WIKI pentru mai multe informatii: https://github.com/celdotro/marketplace/wiki/Import-produse#parametri / Optional field that can conflict with the value specified in the product's line. Please check the WIKI page for more information: https://github.com/celdotro/marketplace/wiki/Import-products#parameters
        array(
            'type' => 'insert',
            'products_name' => 'Canapele terasa outdoor din plastic LOW LITA LOVE TEST',
            'import_code' => '1164',
            'products_model' => '1164',
            'manufcturers_name' => 'Global Network',
            'categories_id' => '225',
            'stoc' => '7',
            'pretf' => '400.0000',
            'products_mage' => 'http://client.localhost.ro/cs-content/cs-photos/products/original/_11294_1_1511516774.jpg',
            'products_description' => '<p><strong>Canapea terasa outdoor din plastic LOW LITA LOVE</strong></p><p><strong><br></strong></p><p><span>Canapea &nbsp;exterior/outdoor fabricata din polietilena cu ajutorul tehnicii de turnare prin rotatie.</span></p><p><span>Rezistenta la intemperii are oroficii de drenaj pentru scurgerea apei, ceea ce o face potrivita atat in interior cat si in gradina.&nbsp;</span></p><p>Disponibila si cu finisaj lacuit pentru culori mai bogate si stralucitoare oferind o calitate mai buna si eleganta intregului produs.Lacuirea face ca acest model de fotoliu sa se integreze in orice mediu.</p><p>&nbsp;</p><p><strong>Dimensiuni:&nbsp;</strong>&nbsp;</p><p>Latime: 118 cm</p><p>Adancime: 80 cm</p><p>Inaltime: 70 cm</p><p>Inaltime sezut:&nbsp; 36 cm</p><p><strong>Greutate: &nbsp;</strong>22 Kg</p><p><strong><br></strong></p>',
            'moneda' => 'RON',
            'garantie' => 1,
            'garantie_pj' => 2,
            'products_url' => 'http://client.localhost.ro/produse/canapele-terasa-outdoor-din-plastic-low-lita-love-1164.html',
            'status' => '1',
            'products_quantity' => '7',
            'charact' => array(
                'Tip:' => array('Disponibil in 15-25 zile de la comanda'),
                'Frecventa retea (MHz):' => array('Plastic'),
                'Viteza maxima:' => array('catering')
            ),
            'hasTVA' => 0,
            'forceInsert' => true
        ),
