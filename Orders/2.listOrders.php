...
$arrOptions = array(
    'date'  =>   array(
        ...
        'maxDate'  =>  '2017-01-02 00:00:00',
    ),
    'customer'  =>  'Client', // daca valoarea elementului este null, 0 sau sirul vid, atunci filtrul nu va fi aplicat / if the element's value is null, 0 or empty string, then it won't be used as a filter
    'customerSign'  =>  'ee',
    'product'  =>   'Produs', // daca valoarea elementului este null, 0 sau sirul vid, atunci filtrul nu va fi aplicat / if the element's value is null, 0 or empty string, then it won't be used as a filter
    'productSign'  =>  'ee',
    ...
    'phoneNumber' => 111 // lipsa elementului sau prezenta sa cu valoarile null sau 0 va determina afisarea tuturor comenzilor si sortarea descrescatoarea in functie de orders_id, altfel va determina afisarea tuturor comenzilor mai mari decat valoarea selectata si ordonarea crescatoare in functie de orders_id / if the element is wissing or its value is null or 0, it will list all orders and sort them ascending by orders_id, otherwise it will show all orders greater than its value and sort them descending by orders_id
);
